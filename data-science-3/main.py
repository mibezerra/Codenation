...
xpca = [0.87747123,  -1.24990363,  -1.3191255, -36.7341814,
...
pca3 = PCA().fit(df_pca)
tuple(pca3.components_.dot(xpca)[0:2].round(3))
...
def q3():
    result = tuple(pca3.components_.dot(xpca)[0:2].round(3))
    return result
    pass
